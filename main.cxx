...
void runPagerank(const G& x, const H& xt, int repeat) {
  ...
  for (float tolerance=1e-1; tolerance>=1e-15; tolerance/=10) {
    ...
    auto a2 = pagerankMonolithicOmp<false, false>(x, xt, init, {repeat, true, damping, Li, tolerance});
    ...
    auto a3 = pagerankMonolithicOmp<true, false>(x, xt, init, {repeat, false, damping, Li, tolerance});
    ...
    auto a4 = pagerankMonolithicOmp<true, false>(x, xt, init, {repeat, true, damping, Li, tolerance});
    ...
    auto a5 = pagerankBarrierfreeOmp<true, false, true>(x, xt, init, {repeat, false, damping, Li, tolerance});
    ...
    auto a6 = pagerankBarrierfreeOmp<true, false, true>(x, xt, init, {repeat, true, damping, Li, tolerance});
    ...
    auto a7 = pagerankBarrierfreeOmp<true, false, false>(x, xt, init, {repeat, false, damping, Li, tolerance});
    ...
    auto a8 = pagerankBarrierfreeOmp<true, false, false>(x, xt, init, {repeat, true, damping, Li, tolerance});
