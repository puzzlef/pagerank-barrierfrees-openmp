...
PagerankResult<T> pagerankLevelwiseSeq(const G& x, const H& xt, const vector<T> *q=nullptr, const PagerankOptions<T>& o={}, const PagerankData<G> *C=nullptr) {
  ...
  return pagerankSeq(xt, ks, 0, ns, pagerankLevelwiseSeqLoopU<O, D, K, T, decltype(ns)>, q, o);
}
...
PagerankResult<T> pagerankLevelwiseSeqDynamic(const G& x, const H& xt, const G& y, const H& yt, const vector<T> *q=nullptr, const PagerankOptions<T>& o={}, const PagerankData<G> *C=nullptr) {
  ...
  return pagerankSeq(yt, ks, 0, ns, pagerankLevelwiseSeqLoopU<O, D, K, T, decltype(ns)>, q, o);
}
